/**
 * camera-report.js - Таблица отчётов камер
 */
    ...
    async showEditForm(id) {
        ...
        try {
            ...
            let fieldsHtml = `
                ...
                <input type="hidden" name="old_id_cam" value="${record.id_cam}">
                <input type="hidden" name="old_recording_date" value="${record.recording_date}">
            `;
            ...
            document.getElementById('edit-form').onsubmit = async (e) => {
                e.preventDefault();
                await this.updateReportRecord(id);
            };
